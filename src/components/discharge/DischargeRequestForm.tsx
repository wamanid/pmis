  ...
  const handleInChargeSelect = (staffId: string) => {
    ...
    if (staff) {
      setFormData((prev) => ({
        ...prev,
        in_charge: staffId,
        in_charge_name: staff.name,
        in_charge_force_number: staff.force_number,
        in_charge_rank: staff.rank,
      }));
  ...
  const handleOfficerInChargeSelect = (staffId: string) => {
    ...
    if (staff) {
      setFormData((prev) => ({
        ...
        officer_in_charge_name: staff.name,
        officer_in_charge_force_number: staff.force_number,
        officer_in_charge_rank: staff.rank,
      }));
                          ...
                          {mockPrisoners.map((prisoner) => (
                            ...
                            >
                              ...
                              <div className="flex flex-col">
                                ...
                                <span className="text-xs text-gray-500">{prisoner.number}</span>
                              </div>
                            </CommandItem>
                          ))}
                        </CommandGroup>
                  ...
                  <PopoverContent className="w-full p-0">
                    <Command>
                      ...
                      <CommandList>
                        ...
                        <CommandGroup>
                          {mockDischargeReasons.map((reason) => (
                            <CommandItem
                              key={reason.id}
                              value={reason.name}
                              onSelect={() => {

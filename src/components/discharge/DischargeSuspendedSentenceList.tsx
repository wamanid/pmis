...
export const DischargeSuspendedSentenceList: React.FC = () => {
  ...
  const [records, setRecords] = useState([
    {
      ...
      duration_of_suspension: 24,
      conditions_for_suspension: 'Good behavior, regular reporting',
      conviction_date: '2024-06-15',
      remarks: 'First time offender',

  ...
  return (
    <div className="w-full h-full p-6 space-y-6">
      ...
      <div className="flex items-center justify-between w-full">
        <div>
          <h1 style={{ color: '#650000' }}>Treatments</h1>
        ...
        <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2" style={{ color: '#650000' }}>
              ...
              {dialogMode === 'create' && 'New Treatment'}
              {dialogMode === 'edit' && 'Edit Treatment'}
              {dialogMode === 'view' && 'View Treatment'}
            </DialogTitle>
          </DialogHeader>
          <TreatmentForm
            treatment={selectedRecord}

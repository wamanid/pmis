...
interface EnrollmentAssessmentListProps {
  onView: (assessment: EnrollmentAssessment) => void;
  onEdit: (assessment: EnrollmentAssessment) => void;
...
const EnrollmentAssessmentList: React.FC<EnrollmentAssessmentListProps> = ({
  ...
  const [filteredAssessments, setFilteredAssessments] = useState<EnrollmentAssessment[]>([]);
